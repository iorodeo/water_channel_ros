...
class SetptSource(object):
    ...
    def __init__(self):
        ...
        self.setpt_rel_pub = rospy.Publisher('setpt', SetptMsg)
    ...
    def update(self):
        ...
        if self.pos_sensor:
            with self.lock:
                ...
                self.pos_setpt = self.pos_sensor + pos_inc
                self.setptMsg.velocity = self.vel_setpt
                self.setptMsg.position = self.pos_setpt
                self.setptMsg.error = self.pos_setpt - self.pos_sensor
