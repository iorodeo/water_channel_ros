...
#
# Created: Sun Nov 20 20:15:01 2011
...
class Ui_SledControl_MainWindow(object):
    def setupUi(self, SledControl_MainWindow):
        ...
        SledControl_MainWindow.resize(807, 720)
        ...
        self.lowerPositionLineEdit = QtGui.QLineEdit(self.widget_8)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lowerPositionLineEdit.sizePolicy().hasHeightForWidth())
        self.lowerPositionLineEdit.setSizePolicy(sizePolicy)
        self.lowerPositionLineEdit.setMaximumSize(QtCore.QSize(70, 16777215))
        self.lowerPositionLineEdit.setObjectName("lowerPositionLineEdit")
        self.horizontalLayout_9.addWidget(self.lowerPositionLineEdit)
        ...
        self.upperPositionLineEdit = QtGui.QLineEdit(self.widget_8)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.upperPositionLineEdit.sizePolicy().hasHeightForWidth())
        self.upperPositionLineEdit.setSizePolicy(sizePolicy)
        self.upperPositionLineEdit.setMaximumSize(QtCore.QSize(70, 16777215))
        self.upperPositionLineEdit.setObjectName("upperPositionLineEdit")
        self.horizontalLayout_9.addWidget(self.upperPositionLineEdit)
        ...
        spacerItem12 = QtGui.QSpacerItem(130, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem19 = QtGui.QSpacerItem(216, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
