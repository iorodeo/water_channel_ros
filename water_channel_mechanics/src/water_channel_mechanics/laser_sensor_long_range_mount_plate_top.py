...
LASER_SENSOR_LONG_RANGE_MOUNT_PLATE_TOP_PARAMETERS = {
...
def get_parameters():
    return copy.deepcopy(LASER_SENSOR_LONG_RANGE_MOUNT_PLATE_TOP_PARAMETERS)

class LaserSensorLongRangeMountPlateTop(csg.Difference):
    def __init__(self):
        super(LaserSensorLongRangeMountPlateTop, self).__init__()
        self.parameters = LASER_SENSOR_LONG_RANGE_MOUNT_PLATE_TOP_PARAMETERS
        self.lssr_parameters = laser_sensor_long_range.get_parameters()
        self.__make_laser_sensor_long_range_mount_plate_top()
        self.__make_holes()
        self.__set_bom()
        self.__make_origin()
    ...
    def __make_laser_sensor_long_range_mount_plate_top(self):
        x = self.parameters['x']
        y = self.parameters['y']
        z = self.parameters['z']
...
if __name__ == "__main__":
    laser_sensor_long_range_mount_plate_top = LaserSensorLongRangeMountPlate_topTop()
    laser_sensor_long_range_mount_plate_top.export()
